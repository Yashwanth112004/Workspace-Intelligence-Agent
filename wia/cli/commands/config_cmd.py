"""WIA CLI `config` command for managing user settings and AI provider configuration."""
...
@click.option("--set-provider", "-p", help="Set default AI provider (e.g. nvidia, openai, local).")
...
def config_cmd(
    ...
    active_provider = cfg.get("ai_provider") or os.environ.get("WIA_AI_PROVIDER") or ("nvidia" if os.environ.get("NVIDIA_API_KEY") else "local")
