...
class WorkspaceGraph:
    ...
    def __init__(self):
        ...
        self._edge_map: dict[tuple[str, str, str], GraphEdge] = {}
    ...
    def add_edge(
        ...
        existing = self._edge_map.get(edge_key)
        if existing:
    ...
    def remove_file(self, rel_path: str) -> None:
        ...
        self._edge_map = {(e.source_id, e.target_id, e.relation_type): e for e in self.edges}
