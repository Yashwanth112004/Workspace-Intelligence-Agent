...
export interface EnvironmentHealthReport {
    ecosystem: 'python' | 'node' | 'rust' | 'go' | 'unknown';
...
export class EnvironmentRepairEngine {
    constructor(private readonly executor: WiaExecutor) {}

    /**
     * Inspect environment health for the given workspace.
     */
    public inspectEnvironment(workspaceRoot: string): EnvironmentHealthReport {
        // 1. Node.js ecosystem
     ...
     */
    public repairEnvironment(workspaceRoot: string): { success: boolean; message: string } {
